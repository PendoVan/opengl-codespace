...
void display(void)
{
    ...
    const int n = 8; // puntos de la figura rellena
    const int m = 10; // puntos de la figura punteada
    ...
    drawShape(n, radio, 0.0f, 0.0f, DRAW_FILL, 0.0f, 0.7f, 0.2f);
    drawShape(m, radio, 0.0f, 0.0f, DRAW_DASHED, 1.0f, 0.6f, 0.0f);
